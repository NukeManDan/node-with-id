...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("nuke-node"),
    impl_name: create_runtime_str!("nuke-node"),
    authoring_version: 1,
    spec_version: 1,
    impl_version: 1,
...
// Copied from [polkadot's runtime](https://github.com/paritytech/polkadot/blob/master/runtime/polkadot/src/lib.rs#L381) and tweaked for use in `nuke-node` , using fixed *Deposit values (not from fn)
// Using the following types macro and impl block:
parameter_types! {
    // Minimum 4 CENTS/byte
    pub const BasicDeposit: Balance = 200;
    pub const FieldDeposit: Balance = 10;
    pub const SubAccountDeposit: Balance = 150;
